...
// Type: ShadowBot.Shell.Command.MachineCodeHandler
...
{
  internal class MachineCodeHandler : CommandHandler
  {
    ...
    static MachineCodeHandler() => vIRtpD5vF7kQ7qvOEa.WUGVB3or3P();
  }
}
