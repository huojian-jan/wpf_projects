...
// Type: ticktick_WPF.Converter.FilterTextColorConverter
      ...
      if (value != null)
      {
        switch ((CardType) value)
        {
          ...
          case CardType.AddMore:
            return (object) ThemeUtil.GetColor("PrimaryColor").ToString();
          ...
          case CardType.Filter:
            return (object) ThemeUtil.GetColor("BaseColorOpacity100_80").ToString();
        }
      }
