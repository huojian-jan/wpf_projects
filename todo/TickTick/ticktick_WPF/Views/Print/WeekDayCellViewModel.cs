...
// Type: ticktick_WPF.Views.Print.WeekDayCellViewModel
...
{
  public class WeekDayCellViewModel : BaseViewModel
  {
    ...
    public static WeekDayCellViewModel Copy(WeekDayCellViewModel model)
    {
      return new WeekDayCellViewModel()
      {
