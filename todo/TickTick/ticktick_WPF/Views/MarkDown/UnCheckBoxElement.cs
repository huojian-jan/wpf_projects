...
// Type: ticktick_WPF.Views.MarkDown.UnCheckBoxElement
...
{
  public sealed class UnCheckBoxElement : FormattedTextElement
  {
    ...
    public override TextRun CreateTextRun(
      ...
      ITextRunConstructionContext context)
    {
      return (TextRun) new UnCheckBoxTextRun((FormattedTextElement) this, (System.Windows.Media.TextFormatting.TextRunProperties) this.TextRunProperties, this._length, (this._editor.FindResource((object) "IsDarkTheme") as bool?).GetValueOrDefault());
    }
    ...
    protected override void OnMouseDown(MouseButtonEventArgs e)
    {
      ...
      if (this._offset + this._length + 3 <= this._context.Document.TextLength - 1)
        this._context.Document.Replace(this._offset + this._length + 3, 1, "x");
      else
        this._editor.Redraw();
