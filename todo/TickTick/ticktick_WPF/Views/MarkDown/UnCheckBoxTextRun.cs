...
// Type: ticktick_WPF.Views.MarkDown.UnCheckBoxTextRun
...
{
  public sealed class UnCheckBoxTextRun : FormattedTextRun
  {
    private readonly int _length;
    private readonly double _size;
    private bool _isDark;

    public UnCheckBoxTextRun(
      ...
      bool sideways)
    {
      ...
      BitmapImage bitmapImage = new BitmapImage(new Uri(this._isDark ? "pack://application:,,,/Assets/md_unchecked_dark.png" : "pack://application:,,,/Assets/md_unchecked_light.png"));
