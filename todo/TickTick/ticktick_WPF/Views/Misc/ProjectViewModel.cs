...
// Type: ticktick_WPF.Views.Misc.ProjectViewModel
...
{
  public class ProjectViewModel : SelectableItemViewModel
  {
    protected ProjectViewModel()
    {
    }

    public ProjectViewModel(string id, string title, bool share, bool isNote)
    {
